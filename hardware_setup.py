...
nxt = Pin(BUTTON_Y, Pin.IN, Pin.PULL_UP)  # Move to next control
sel = Pin(BUTTON_X, Pin.IN, Pin.PULL_UP) # Operate current control
prev = None  # Move to previous control
increase = Pin(BUTTON_A, Pin.IN, Pin.PULL_UP)  ### Pin(BUTTON_A, Pin.IN, Pin.PULL_UP)  # Increase control's value
decrease = Pin(BUTTON_B, Pin.IN, Pin.PULL_UP)  ### Pin(11, Pin.IN, Pin.PULL_UP)  # Decrease control's value
